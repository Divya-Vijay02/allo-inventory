...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitives.Root
    ref={ref}
    className={cn(
      "group pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-xl border p-4 pr-6 shadow-md transition-all",
      variant === "default" && "bg-card border-border text-foreground",
      variant === "destructive" && "bg-destructive border-destructive text-white",
      className
    )}
    {...props}
  />
